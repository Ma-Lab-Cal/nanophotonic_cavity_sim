...
$0.83$, and the best-so-far envelope (red) shows that the optimizer reaches its
...
$-\log\eta$ from the non-gradient checks falls from $4.6$ to $0.18$, and its
...
[Fig.~\ref{fig:opt}(a)] climbs from $\eta=0.01$ to $0.83$: the optimizer first
